...
class ReportSchedule(AuditMixinNullable, ExtraJSONMixin, Model):
    ...
    # `extra` below is a type-only redeclaration of the property inherited
    # from ExtraJSONMixin; newer SQLAlchemy versions require class-level
    # annotations on mapped classes to use Mapped[] unless this is set.
