...
class _Base:
    # Several model classes below use plain (non-Mapped[]) type annotations,
    # e.g. `database: Database = relationship(...)`. Newer SQLAlchemy
    # versions require this opt-out to accept those legacy-style
    # annotations on mapped classes.
