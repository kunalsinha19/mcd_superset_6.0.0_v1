...
`;var A;function x({user:e}){const t=(0,i.DP)(),[s,m]=(0,n.useState)({resetPassword:!1,edit:!1}),h=e=>m((t=>({...t,[e]:!0}))),p=e=>m((t=>({...t,[e]:!1}))),{addDangerToast:f}=(0,c.Yf)(),[x,$]=(0,n.useState)(e);(0,n.useEffect)((()=>{P()}),[]);const P=(0,n.useCallback)((()=>{o.A.get({endpoint:"/api/v1/me/"}).then((({json:e})=>{const t={...e.result,firstName:e.result.first_name,lastName:e.result.last_name};$(t)})).catch((e=>{f("Failed to fetch user info:",e)}))}),[x]),k=[{name:(0,a.FD)(a.FK,{children:[(0,a.Y)(b.F.LockOutlined,{iconColor:t.colorPrimary,iconSize:"m",css:r.AH`
