...
`,m=({text:e,header:t})=>{const i=(0,c.A)(e);return(0,o.FD)(o.FK,{children:[t&&(0,o.Y)(f,{children:t}),i.map((e=>(0,o.Y)("div",{children:e},e)))]})},w=16,g={dashboards:0,table:1,sql:2,rows:3,tags:4,description:5,owner:6,lastModified:7},x=s.I4.div`
...
`,f=(0,d.memo)((({title:e,placeholder:t,onSave:i,canEdit:a,label:s})=>{const f=(0,o.DP)(),[m,w]=(0,d.useState)(!1),[g,x]=(0,d.useState)(!1),[b,v]=(0,d.useState)(e||""),{width:y,ref:$}=(0,c.uZ)(),{width:Y,ref:S}=(0,c.uZ)({refreshMode:"debounce"});(0,d.useEffect)((()=>{v(e)}),[e]),(0,d.useEffect)((()=>{if(m&&null!=$&&$.current&&$.current.setSelectionRange){const{length:e}=$.current.value;$.current.setSelectionRange(e,e),$.current.scrollLeft=$.current.scrollWidth}}),[m]),(0,d.useLayoutEffect)((()=>{null!=$&&$.current&&($.current.textContent=b||t)}),[b,t,$]),(0,d.useEffect)((()=>{var e;const t=null==(e=$.current)?void 0:e.input;t&&(t.scrollWidth>t.clientWidth?x(!0):x(!1))}),[y,Y]);const T=(0,d.useCallback)((()=>{a&&!m&&w(!0)}),[a,m]),k=(0,d.useCallback)((()=>{if(!a)return;const t=b.trim();v(t),e!==t&&i(t),w(!1)}),[a,b,i,e]),F=(0,d.useCallback)((e=>{a&&m&&v(e.target.value)}),[a,m]),z=(0,d.useCallback)((e=>{if(!a)return;e.preventDefault();const{activeElement:t}=document;t&&t instanceof HTMLElement&&t.blur()}),[a]);return(0,n.FD)("div",{css:h,ref:S,children:[(0,n.Y)(p.m,{id:"title-tooltip",title:g&&b&&!m?b:null,children:(0,n.Y)(u.A,{"data-test":"editable-title-input",variant:"borderless","aria-label":null!=s?s:(0,r.t)("Title"),className:"dynamic-title-input",value:b,onChange:F,onBlur:k,onClick:T,onPressEnter:z,placeholder:t,css:l.AH`
              ${!a&&"&[disabled] {\n                  cursor: default;\n                }\n              "}
              ...
              ${y&&y>0&&l.AH`
                width: ${y}px;
              `}
            `,disabled:!a})}),(0,n.Y)("span",{ref:$,className:"input-sizer","aria-hidden":!0,tabIndex:-1})]})}));var m=i(28827),w=i(54569),g=i(88217);const x=e=>l.AH`
...
`,$=({editableTitleProps:e,showTitlePanelItems:t,certificatiedBadgeProps:i,showFaveStar:l,faveStarProps:d,titlePanelAdditionalItems:c,rightPanelAdditionalItems:p,additionalActionsMenu:u,menuDropdownProps:h,showMenuDropdown:$=!0,tooltipProps:Y})=>{const S=(0,o.DP)();return(0,n.FD)("div",{css:b,className:"header-with-actions",children:[(0,n.FD)("div",{className:"title-panel",children:[(0,n.Y)(f,{...e}),t&&(0,n.FD)("div",{css:v,children:[(null==i?void 0:i.certifiedBy)&&(0,n.Y)(w.T,{...i}),l&&(0,n.Y)(s.$,{...d}),c]})]}),(0,n.FD)("div",{className:"right-button-panel",children:[p,(0,n.Y)("div",{css:y,children:$&&(0,n.Y)(m.ms,{trigger:["click"],popupRender:()=>u,...h,children:(0,n.Y)(g.$,{css:x,buttonStyle:"tertiary","aria-label":(0,r.t)("Menu actions trigger"),tooltip:null==Y?void 0:Y.text,placement:null==Y?void 0:Y.placement,"data-test":"actions-trigger",children:(0,n.Y)(a.F.EllipsisOutlined,{iconColor:S.colorPrimary,iconSize:"l"})})})})]})]})}}}]);