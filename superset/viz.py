...
# Optional geohash import - geohash package not available on all platforms
try:
    import geohash
except ModuleNotFoundError:
    geohash = None  # type: ignore
...
class BaseDeckGLViz(BaseViz):
    ...
    def reverse_geohash_decode(geohash_code: str) -> tuple[str, str]:
        if geohash is None:
            raise ImportError(
                "geohash module is not available. Please install python-geohash to use this feature."
            )
